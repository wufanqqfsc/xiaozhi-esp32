...
- `.cursor/skills/esp32-http-api/SKILL.md` — 设备 HTTP API（Trae: `.trae/skills/esp32-http-api/SKILL.md`）
- `.cursor/skills/xiaozhi-code-wiki/SKILL.md` — 项目架构（Trae: `.trae/skills/xiaozhi-code-wiki/SKILL.md`）
