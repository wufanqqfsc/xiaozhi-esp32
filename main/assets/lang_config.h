...
namespace Lang {
    ...
    namespace Strings {
        ...
        constexpr const char* INTERNET_FAILED = "网络连接失败";
    ...
    namespace Sounds {
        ...
        extern const char ogg_study_focus_bgm_start[] asm("_binary_study_focus_bgm_ogg_start");
        extern const char ogg_study_focus_bgm_end[] asm("_binary_study_focus_bgm_ogg_end");
        static const std::string_view OGG_STUDY_FOCUS_BGM {
        static_cast<const char*>(ogg_study_focus_bgm_start),
        static_cast<size_t>(ogg_study_focus_bgm_end - ogg_study_focus_bgm_start)
        };
        ...
        extern const char ogg_zhanbu_start[] asm("_binary_zhanbu_ogg_start");
        extern const char ogg_zhanbu_end[] asm("_binary_zhanbu_ogg_end");
        static const std::string_view OGG_ZHANBU {
        static_cast<const char*>(ogg_zhanbu_start),
        static_cast<size_t>(ogg_zhanbu_end - ogg_zhanbu_start)
        };
    }
}
