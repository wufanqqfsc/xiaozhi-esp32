...
private:
    ...
    void Initializest77916Display() {
        ...
        // Force vendor-specific initialization for ESP32-S3-Touch-LCD-1.85B
        // The register detection may fail, so we always use the known-good init sequence
        ESP_LOGI(TAG, "Forcing vendor-specific initialization for ESP32-S3-Touch-LCD-1.85B");
