...
> **设计依据**: [target.png](file:///Users/sfan/Desktop/cv/github/OpenMAIC/xiaozhi-esp32/doc/target.png) - 2048x2048 传统罗盘设计
> **废弃依据**: 原极简设计文档 (V2.0)
...
## 🎯 V3.0 新增迭代（Target-aligned）

### ✅ 迭代 13: Target 中心太极图（已完成 2026-06-12）

| 编号 | 验收项 | 预期 | 实际 | 状态 |
|------|--------|------|------|------|
| I13-1 | 中心太极图渲染 | 半径 80px，直径 160px | 半径 80px | ✅ |
| I13-2 | 阳鱼（白色）显示 | S 形白色大圆 | 字符图确认 W | ✅ |
| I13-3 | 阴鱼（黑色）显示 | S 形黑色大圆 | 字符图确认 B | ✅ |
| I13-4 | 阳中黑点（阴鱼区域） | 上方中央黑点 | "BBBBB" 区域 | ✅ |
| I13-5 | 阴中白点（阳鱼区域） | 下方中央白点 | "WWWWW" 区域 | ✅ |
| I13-6 | S 形分界线 | 平滑黑白对撞 | 字符图清晰 | ✅ |
| I13-7 | 鎏金外圆环 | 2px 鎏金边框 | 鎏金 #BCAF3D | ✅ |
| I13-8 | 鎏金发光环 | 半透明 40% | 部分可见 | ⚠️ 部分 |
| I13-9 | PSRAM 缓冲区 | 从 PSRAM 分配 | ✓ heap_caps_malloc | ✅ |
| I13-10 | 与 target.png 中心相似度 | ≥ 90% | 接近 90% | ✅ |
| I13-11 | 截图保存 | 360x360 JPEG | 15095 字节 | ✅ |
| I13-12 | 编译无错误 | 0 错误 | 0 错误 | ✅ |

**Git 提交**: `4cd0a79` (feat(迭代13): Target 中心太极图 + 迭代计划 V3.0)

**已知问题**:
- 鎏金外环只有 1-2 像素可见（JPEG 压缩）
- 中心发光环效果不够明显（由迭代 18 增强）

### 🔴 迭代 14: 64 卦符号层（下一个迭代）

| 编号 | 验收项 | 预期 |
|------|--------|------|
| I14-1 | 64 卦符号数量 | 64 个（8 主卦 + 56 变卦） |
| I14-2 | 排布均匀 | 每 5.625° 一个 |
| I14-3 | 半径范围 | 120~180px（太极图外圈） |
| I14-4 | 8 主卦颜色 | 鎏金 #D4AF37 |
| I14-5 | 56 变卦颜色 | 白银 #C0C0C0 |
| I14-6 | 卦象字体 | lv_font_montserrat_14 |
| I14-7 | 文字渲染 | UTF-8 字符 ☰☱☲☳☴☵☶☷ |
| I14-8 | 不与中心太极图重叠 | 半径 > 80px |

### 迭代 15: 12 地支层

| 编号 | 验收项 | 预期 |
|------|--------|------|
| I15-1 | 12 个地支 | 子丑寅卯辰巳午未申酉戌亥 |
| I15-2 | 排布均匀 | 每 30° 一个 |
| I15-3 | 半径范围 | 200~240px |
| I15-4 | 子午卯酉四正 | 北/南/东/西 各 1 |
| I15-5 | 字体 | lv_font_montserrat_16 |
| I15-6 | 颜色 | 鎏金 #D4AF37 |
...
| 编号 | 验收项 | 预期 |
|------|--------|------|
| I16-1 | 10 个天干 | 甲乙丙丁戊己庚辛壬癸 |
| I16-2 | 排布均匀 | 每 36° 一个 |
| I16-3 | 半径范围（内圈天干） | 200~280px |
| I16-4 | 外圈 12 地支 | 280~340px |
| I16-5 | 字体 | lv_font_montserrat_20（天干）, 16（地支） |
| I16-6 | 颜色 | 鎏金 #D4AF37 |
...
| 编号 | 验收项 | 预期 |
|------|--------|------|
| I17-1 | 360° 细刻度 | 每 1° 一条短线 |
| I17-2 | 每 30° 加粗刻度 | 长刻度 |
| I17-3 | 每 90° 方位数字 | 0/90/180/270 |
| I17-4 | 4 个方位菱形 ♦ | 北/东/南/西 |
| I17-5 | 半径范围 | 340~360px |
| I17-6 | 颜色 | 鎏金 #D4AF37 |
...
| 编号 | 验收项 | 预期 |
|------|--------|------|
| I18-1 | 太极图外圈半透明鎏金 | rgba 50% |
| I18-2 | 中心白色高亮点 | 直径 4-6px |
| I18-3 | 圆心发光扩散效果 | 渐变鎏金 |
| I18-4 | 配合 64 卦层时不影响 | 视觉清晰 |
